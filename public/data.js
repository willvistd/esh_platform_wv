...
window.WV_DATA = (() => {
  ...
  const roles = [
    ...
    { id: "staff",        name: "팀 공용",      desc: "팀 공용계정 · 모든 업무·카테고리 접근", kind: "internal", siteAdmin: false, color: "#7280a5", builtin: true },
    { id: "site_manager", name: "현장대리인",   desc: "단위 사업장 직원",  kind: "site",     siteAdmin: false, color: "#8b5cf6", builtin: true },
  ];
